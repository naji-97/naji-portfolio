...
$ git clone <https://github.com/naji-97/Portfolio-/tree/mobile-portfolio)><br>
2. Navigate to the location of the folder in your machine:<br>
(https://github.com/naji-97/Portfolio-/tree/mobile-portfolio)<br>
...
- GitHub: [@Naji-](https://github.com/Naji-97)
